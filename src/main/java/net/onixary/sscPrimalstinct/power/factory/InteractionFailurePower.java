...
public final class InteractionFailurePower extends Power {
    ...
    public final ActionFactory<Entity>.Instance failureAction;
    public final ActionFactory<Entity>.Instance successAction;
    public InteractionFailurePower(PowerType<?> type, LivingEntity entity, float blocks, float containers,
                                   ActionFactory<Entity>.Instance failureAction,
                                   ActionFactory<Entity>.Instance successAction) {
        super(type, entity);
    ...
    public static PowerFactory<?> getFactory() {
        return new PowerFactory<>(new Identifier("ssc-primalstinct", "interaction_failure"),
            ...
            data -> (type, entity) -> new InteractionFailurePower(type, entity,
                data.getFloat("block_chance"), data.getFloat("container_chance"),
                data.get("failure_action"), data.get("success_action"))).allowCondition();
    }
}
